---
name: create-hooks
description: Create Claude Code hooks (PreToolUse, PostToolUse, Stop, SessionStart, UserPromptSubmit). Use when setting up event listeners, validating commands, or automating workflows.
---
